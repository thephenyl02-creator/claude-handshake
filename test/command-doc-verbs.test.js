...
// unnoticed.
const PINNED = {
  '[C bin/handshake.js:44-58]': 'function parseArgs',
  '[C bin/handshake.js:525-535]': 'recordMemberEmail(state, founderMember',
  '[C bin/handshake.js:704-709]': 'recordMemberEmail(state, member',
  '[C bin/handshake.js:913-983]': 'async function cmdPost',
  '[C bin/handshake.js:917-920]': "const allowed = ['note.discovery'",
  '[C bin/handshake.js:921]': "args._.slice(1).join(' ')",
  '[C bin/handshake.js:951-957]': 'below the 50% floor',
  '[C bin/handshake.js:1134-1137]': 'args.flags.refresh !== undefined',
  '[C bin/handshake.js:1368-1370]': '--grace must be 0..86400',
  '[C bin/handshake.js:1384-1412]': 'async function cmdLeave',
  '[C bin/handshake.js:1393-1396]': '--reason must be session_end',
  '[C bin/handshake.js:1788-1797]': 'async function cmdNote',
  '[C bin/handshake.js:1793-1798]': '!kinds.includes(kind)',
  '[C bin/handshake.js:1802]': "args._.slice(1).join(' ').trim() ||",
  '[C bin/handshake.js:1806-1812]': 'async function cmdWarn',
  '[C bin/handshake.js:1807-1810]': "args._[0] !== 'overlap'",
  '[C bin/handshake.js:1817-1821]': "args.flags.change === 'string' ? args.flags.change : null",
  '[C bin/handshake.js:1823-1835]': 'body.files_added',
  '[C bin/handshake.js:1896-1899]': 'args.flags.reason.slice(0, 120)',
  '[C bin/handshake.js:1898-1920]': 'presence.update',
  '[C bin/handshake.js:1969-1975]': 'stopPosting',
  '[C bin/handshake.js:2117-2123]': 'recordMemberEmail(state, founderMember',
  '[C bin/handshake.js:3391-3399]': 'const COMMANDS = {',
  '[C bin/handshake.js:3410-3423]': "'  presence  working|waiting|blocked|tooling_broken",
  '[C bin/handshake.js:2742]': 'function stateBranchPeerLines',
  '[C bin/handshake.js:2761-2768]': 'stateBranch.lsRemoteRef(root, stateBranch.STATE_REF',
  '[C bin/handshake.js:2922]': 'function stateBranchStatusLines',
  '[C bin/handshake.js:3164]': "refuseIfChild('pair')",
  '[C bin/handshake.js:3249]': "--yes is not accepted for pair",
  '[C bin/handshake.js:3359]': 'PUBLIC_OVERRIDE_PHRASE =',
  '[C lib/repo.js:25]': 'GUARD_TTL_MS = 600',
  '[C lib/repo.js:422-427]': "'config', '--get', 'user.email'",
  '[C lib/state.js:47-57]': 'CLAUDE_PLUGIN_DATA is deliberately NOT consulted',
  '[C lib/workspace-files.js:668-699]': 'function checkShardAuthors',
  '[C lib/workspace-files.js:680,685]': 'no_recorded_email_for_member',
  '[C lib/workspace-files.js:786-788]': 'unknown, which is not the same as clean',
  '[C installers/install.sh:57,757-758]': '$FALLBACK_ROOT/$VERSION',
  '[C installers/install.sh:843-867,896]': 'CLAUDE_PLUGIN_ROOT',
  '[C installers/install.ps1:821-852,873]': 'CLAUDE_PLUGIN_ROOT',
};

const SECURITY_PINNED = {
  '[C bin/handshake.js:412-417]': 'function defaultMemberName',
  '[C bin/handshake.js:415]': 'slice(0, 48)',
  '[C bin/handshake.js:416]': "return base || 'founder'",
  '[C bin/handshake.js:455-456]': 'asFlag || defaultMemberName()',
  '[C bin/handshake.js:641-643]': 'member name (printable ASCII, 1-64 chars)',
  '[C bin/handshake.js:644-646]': 'must be 1-64 printable ASCII chars',
  '[C bin/handshake.js:1276-1281]': 'shard_warning: (repoState.warnings',
  '[C bin/handshake.js:1314-1319]': "shard_warning === 'non_member_commit'",
  '[C bin/handshake.js:2060-2061]': 'asFlag || defaultMemberName()',
  '[C bin/handshake.js:534,708,2115]': 'recordMemberEmail(state',
  '[C bin/handshake.js:463,489]': 'founderMember = founderName',
  '[C bin/handshake.js:470,489,2066]': 'joined.member_id || founderName',
  '[C bin/handshake.js:177-179,208]': 'member: cfg.member',
};
